%This code considers a PM scenario where Alice prepares the 6 eigenvectors of Pauli matrices and Bob measures 11 Thomson measurements.
%We show that the statistics of this scenario cannot be obtained by classical trits
%Before running this code, ensure that the file Mby11.mat storing the measurements is in the directory path 
...
%Load the 11 Thomson measurements
load('Mby11.mat')
